...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (tableView == leftHeaderTableView) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            NSString *tagStr = [NSString stringWithFormat:@"%ld_%d", (long)section, i];
            subView.tag = (int)tagStr;
            
            NSString *columnStr = [NSString stringWithFormat:@"%ld_%d", (long)section, i];
...
- (void)setUpTopHeaderScrollView {
    ...
    for (int i = 0; i < count; i++) {
        ...
        [label setTextColor:[UIColor colorWithRed:80/255.0f green:80/255.0f blue:80/255.0f alpha:1]];
        [label sizeToFit];
...
- (void)contentHeaderTap:(UITapGestureRecognizer *)recognizer {
    ...
    NSString *columnStr = [NSString stringWithFormat:@"%d_%ld", section, (long)column];
    ...
    if (section == -1) {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            NSString *str = [NSString stringWithFormat:@"%d_%ld", iPath.section, (long)iPath.row];
