...
- (void)showInView:(UIView *) view
{
    ...
    self.frame = CGRectMake(0, view.frame.size.height, size.width, self.frame.size.height);
    [view addSubview:self];
    
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, view.frame.size.height - self.frame.size.height, size.width, self.frame.size.height);
    }];
...
- (void)cancelPicker
{
    ...
    [UIView animateWithDuration:0.3
                     animations:^{
                         self.frame = CGRectMake(0, self.frame.origin.y+self.frame.size.height, size.width, self.frame.size.height);
                     }
